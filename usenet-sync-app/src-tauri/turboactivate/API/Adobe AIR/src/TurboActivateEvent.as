package
{
	...
	public class TurboActivateEvent extends Event 
	{
		...
		/**
		 * Listeners to "IS_GENUINE_EX" event are called as a result of call to the TurboActivate.IsGenuineEx() function. 
		 */
		public static const IS_GENUINE_EX:String = "ta_IsGenuineEx";
		...
		/**
		 * Listeners to "GENUINE_DAYS" event are called as a result of call to the TurboActivate.GenuineDays() function. 
		 */
		public static const GENUINE_DAYS:String = "ta_GenuineDays";
		...
		/**
		 * Listeners to "DEACT_REQ_TO_FILE" event are called as a result of call to the TurboActivate.DeactivationRequestToFile() function. 
		 */
		public static const DEACT_REQ_TO_FILE:String = "ta_DeactivationRequestToFile";
		...
		/**
		 * The uint response from a TurboActivate function. This contains the result of calls to TrialDaysRemaining, and IsGenuineEx.
		 */
