...
# IMPORTANT: nntplib is DISCONTINUED in Python 3.11+
# We use pynntp package which provides the 'nntp' module (NOT 'pynntp')
# Install with: pip install pynntp
# Import as: from nntp import NNTPClient
